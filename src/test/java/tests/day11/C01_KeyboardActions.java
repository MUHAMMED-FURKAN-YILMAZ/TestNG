...
public class C01_KeyboardActions extends TestBase {
    ...
    public void test(){
        ...
        */
        ...
        // simdiye kadar once locate edip, o webelement uzerinden sendKeys yapiyoduk
        ...
        String searchedWord="samsung A71";
        String actualTitle= driver.getTitle();
        Assert.assertTrue(actualTitle.contains(searchedWord),"aranan kelime baslikta bulunamadi");
